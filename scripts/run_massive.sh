...
#SBATCH -t 1-00:00:00
#SBATCH -o massive.log
#output-%j
#SBATCH -e massive.log
#error-%j
#SBATCH --exclusive
...
do
	...
	srun --cpus-per-task=$threads ./tridiagonals 20000 10 8 1 ./timing_mn5/xxl/${threads}_threads.csv #1> small.log 2> small.log
done 