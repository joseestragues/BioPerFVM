...
for voxels in 25000 20000 15000 10000
do
	...
	do
		...
		do
			...
			srun ./test_VS $voxels  $overlap  $substrates ./overlap/voxels_${voxels}/substrates_${substrates}/factor_${factor}/${nodes}_node.csv 1> /dev/null  2> ./overlap/voxels_${voxels}/substrates_${substrates}/factor_${factor}/${nodes}_node.log 
		done
	done	
done
